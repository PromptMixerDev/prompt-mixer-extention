...
(function() {
  ...
  // chatgpt.com теперь обрабатывается отдельным скриптом
}
  ...
  Object.assign(button.style, {
    backgroundColor: 'rgb(0, 0, 0)', // OpenAI green
    color: 'white',
    borderRadius: '999px',
    width: '36px',
    height: '36px',
  ...
  button.addEventListener('mouseover', () => {
    button.style.backgroundColor = 'rgb(77, 77, 77)'; // Darker green on hover
  });
  ...
  if (position === 'absolute') {
    // Единые значения для всех сайтов OpenAI
